...
// Active sphere count per drill-depth. At depth 3 (3 spheres) the next click
// commits to the chosen one — terminal state with just the focused sphere.
const COUNT_SEQUENCE = [14, 8, 5, 3, 1];
